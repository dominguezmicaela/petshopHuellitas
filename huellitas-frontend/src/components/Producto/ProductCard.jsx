  ...
  return (
    <>
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ background: "linear-gradient(135deg, #3d6b4f, #2d5140)" }}
              >Nuevo</span>

              <div
                className="h-72 flex items-center justify-center overflow-hidden"
                style={{ background: "linear-gradient(135deg, #faf5ee 0%, #f2e9dc 100%)" }}
              >
                {producto.img ? (
              ...
              <div className="p-6">
                <div className="flex items-start justify-between gap-3 mb-2">
                  <h3 className="font-bold text-lg leading-snug flex-1" style={{ color: "#2d5140" }}>
                    {producto.nombre}
                  </h3>
                  <span className="font-extrabold text-xl whitespace-nowrap" style={{ color: "#2d7a3c" }}>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {producto.categoria && (
                    <span className="text-xs font-semibold px-3 py-1.5 rounded-full" style={{ background: "#f2e9dc", color: "#3d6b4f" }}>
                      🏷 {producto.categoria}
                    </span>
                  )}
                  <span className="text-xs font-semibold px-3 py-1.5 rounded-full" style={{ background: "#ecfdf5", color: "#166534" }}>✓ En stock</span>
                  <span className="text-xs font-semibold px-3 py-1.5 rounded-full" style={{ background: "#f2e9dc", color: "#3d6b4f" }}>🚚 Envío disponible</span>
                </div>
                <motion.button
                  whileTap={{ scale: 0.96 }}
                  onClick={handleAdd}
                  ...
                  style={{
                    background: added ? "linear-gradient(135deg, #d1fae5, #a7f3d0)" : "linear-gradient(135deg, #3d6b4f, #2d5140)",
      ...
      >
        ...
        {/* Info — flex column para que el botón quede siempre abajo */}
        <div className="p-4" style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="font-bold text-sm leading-snug line-clamp-1 flex-1" style={{ color: "#2d5140" }}>
              {producto.nombre}
            </h3>
            <span className="font-extrabold text-sm whitespace-nowrap" style={{ color: "#2d7a3c" }}>
              ${producto.precio?.toLocaleString("es-AR")}
            </span>
          </div>

          <p className="text-xs leading-relaxed line-clamp-2 mb-3" style={{ color: "#8aaa96" }}>
            {producto.descripcion}
          </p>

          {/* marginTop auto empuja el botón siempre al fondo */}
          <div style={{ marginTop: "auto" }}>
            <motion.button
              ...
              style={{
                background: added ? "#ecfdf5" : "linear-gradient(135deg, #3d6b4f, #2d5140)",
                color: added ? "#166534" : "#fff",
            ...
            <p className="text-center text-xs mt-2.5 font-medium select-none" style={{ color: "rgba(61,107,79,0.45)" }}>
              Tocá para ver más →
            </p>
          </div>
        </div>
