// components/Carrito/CarritoVacio.jsx
...
const CarritoVacio = () => (
  <div style={{
    ...
    <div style={{
      ...
      <h2 style={{ fontWeight: 800, fontSize: "1.6rem", color: C.verde2, marginBottom: "0.8rem" }}>
        Tu carrito está vacío
      </h2>
      <p style={{ fontSize: "0.95rem", color: C.muted2, lineHeight: 1.6, marginBottom: "2.5rem" }}>
        ¡Descubrí nuestros productos y encontrá lo mejor para tu mascota!
      </p>

      <Link to="/" style={{
        display: "inline-block", padding: "0.95rem 2.5rem",
        background: C.gradiente, color: C.sobreVerde, textDecoration: "none",
